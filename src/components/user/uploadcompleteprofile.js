...
handleSubmit(e) {  
  ...
  <Container style={{border:'1px solid rgba(102, 51, 153, 0.404)'}}>
   ...
   <Form onSubmit={this.handleSubmit}>
       ...
       <br/>
       <h6 style={{color:'rebeccapurple'}}>Before you can post a gig, please provide the following
         information inorder to populate your profile and increase your chances of being hired.
       </h6>
       <br/><br/>
