...
import {SEARCH_BIDS, SEARCH_SERVICES, GET_USER} from '../graphql/QueryResolver';
      ...
      this.state = {
        ...
        this.finalDisplay = () =>{
              ...
              if(this.state.allItems.length==0){
                return<Row>
                <h6 style={{color: 'rebeccapurple', marginTop: '50px', paddingLeft: '45px'}}>Nothing matching <span style={{color: '#25292C'}}>{this.props.searchQuery}</span> has been found. If you want to make a request for <span style={{color: '#25292C'}}>{this.props.searchQuery}</span> <a style={{color: 'blue'}} href="/upload/">Click here</a> to post a bid.</h6>
                </Row>
              }else{
///////////showing services/////////////////////////////////////////////////////////////////////////////////////////
